...
export const tr = {
  ...
  'live.region.ET': 'Kontrast tutan tümör',
  'live.noReference': 'Canlı vakada referans etiketi yoktur; Dice gibi referansa bağlı ölçütler gösterilmez.',
  'live.reportUnreadable': 'Rapor okunamadı; sayılar gösterilmiyor. Sonuç ZIP içinde yer alıyor.',
  'live.flag.nonEnhancingTumor': 'Tümör kontrast tutmuyor ama model bir tümör çekirdeği işaretledi. Bu bulguyu doğrulamadan kullanmayın.',
  'live.flag.unknown': 'Model bu sonuçta inceleme gerektiren bir bulgu bildirdi.',
  'live.flag.evidence': 'Çekirdek {core} voksel, kontrast tutan {enhancing} voksel (eşik {threshold}).',
  ...
  'mesh.liveFallbackHint': 'Sonuç ZIP’i yine de indirilebilir; NIfTI ve GLB dosyaları içindedir.',
...
export const en: Record<MessageKey, string> = {
  ...
  'live.region.ET': 'Enhancing tumour',
  'live.noReference': 'A live case has no reference label, so measures that depend on one, such as Dice, are not shown.',
  'live.reportUnreadable': 'The report could not be read, so no numbers are shown. It is still inside the result ZIP.',
  'live.flag.nonEnhancingTumor': 'The tumour does not enhance, yet the model marked a tumour core. Do not use this finding without confirming it.',
  'live.flag.unknown': 'The model reported a finding in this result that needs review.',
  'live.flag.evidence': 'Core {core} voxels, enhancing {enhancing} voxels (threshold {threshold}).',
  ...
  'mesh.liveFallbackHint': 'The result ZIP can still be downloaded; the NIfTI and GLB files are inside it.',
